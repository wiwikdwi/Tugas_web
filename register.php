  ...
  <nav class="navbar navbar-inverse navbar-fixed-top">
    <div class="container">
      <div class="navbar-header">
        ...
        <a class="navbar-brand" href="http://Upload-Download.web/" target="_blank">Upload-Download.web</a>
      </div>
      ...
      <div class="col-md-6 col-md-offset-3">
        ...
        <form class="form-horizontal" method="post">
          ...
          <div class="form-group">
            ...
            <div class="col-md-8">
              <input type="email" name="email" class="form-control" placeholder="ghajj@gmail.com" required="required">
            </div>
          </div>
          <div class="form-group">
